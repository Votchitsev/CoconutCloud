...
from coconut_cloud.cloud.views.user_view import RegistrUserView, get_detail_user_list, delete_user
from coconut_cloud.cloud.views.file_views import FileView
from coconut_cloud.cloud.views.auth_view import login_view, get_csrf_token, me_view, logout_view
